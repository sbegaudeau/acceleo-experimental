 ...
 *******************************************************************************/
package com.github.sbegaudeau.acceleo.mylyn;
 ...
 * @since 0.1
 */
public final class AcceleoMylynMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "com.github.sbegaudeau.acceleo.mylyn.acceleomylynmessages"; //$NON-NLS-1$
